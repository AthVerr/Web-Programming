...
public class SaxParserDataStore extends DefaultHandler {
	...
	TV     tv;
    Accessory accessory;
	//one hashmap for each category/class
	...
	HashMap<String,String> accessoryHashMap; //match the accessories with product categories  
...
////////////////////////////////////////////////////////////
	...
	// when xml start element is parsed store the id into respective hashmap for phone,laptops etc 
    @Override
    public void startElement(String str1, String str2, String elementName, Attributes attributes) throws SAXException {
//search for id depending the category 
	...
	// when xml end element is parsed store the data into respective hashmap for phone,laptops etc respectively
    @Override
    public void endElement(String str1, String str2, String element) throws SAXException {
 //we have a product and put its id into table 
...
//call the constructor to parse the xml and get product details
 public static void addHashmap() {
		...
		new SaxParserDataStore(TOMCAT_HOME+"\\webapps\\BestDeal\\ProductCatalog.xml"); //find the xml file 
    } 
}
